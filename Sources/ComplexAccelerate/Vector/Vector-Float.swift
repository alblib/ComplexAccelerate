...
public extension Vector where Element == Float{
    ...
    static func create(repeating: Float, count: Int) -> [Float]
    {
        ...
        return [Element](unsafeUninitializedCapacity: count) { buffer, initializedCount in
            ...
            withUnsafePointer(to: repeating) { iPtr in
                vDSP_vfill(iPtr, oPtr, 1, vDSP_Length(count))
            }
            initializedCount = count
        }
    }
    static func arithmeticProgression(initialValue: Float, increment: Float, count: Int) -> [Float]
    {
        if count <= 0{
            return []
        }
    ...
    static func arithmeticProgression(initialValue: Float, to finalValue: Float, count: Int) -> [Float]
    {
        arithmeticProgression(initialValue: initialValue, increment: (finalValue - initialValue) / Float(count - 1), count: count)
    }
    static func geometricProgression(initialValue: Float, ratio: Float, count: Int) -> [Float]
    {
        vForce.exp(vDSP.ramp(withInitialValue: Foundation.log(initialValue), increment: Foundation.log(ratio), count: count))
    }
    static func geometricProgression(initialValue: Float, to finalValue: Float, count: Int) -> [Float]
    {
    ...
    @inline(__always)
    static func square<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
    ...
    @inlinable
    static func cot<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
    ...
    @inlinable
    static func acot<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
    ...
    @inlinable
    static func cosh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.cosh(vector)
    }
    
    @inlinable
    static func sinh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.sinh(vector)
    }
    
    @inlinable
    static func tanh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.tanh(vector)
    }
    
    @inlinable
    static func coth<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
    ...
    @inlinable
    static func acosh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.acosh(vector)
    }
    
    @inlinable
    static func asinh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.asinh(vector)
    }
    
    @inlinable
    static func atanh<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
        vForce.atanh(vector)
    }
    
    @inlinable
    static func acoth<VectorA>(_ vector: VectorA) -> [Float]
    where VectorA: AccelerateBuffer, VectorA.Element == Element{
