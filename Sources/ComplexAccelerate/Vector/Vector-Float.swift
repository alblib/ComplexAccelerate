...
public extension Vector where Element == Float{
    internal static func parallel<VectorA, VectorB>(_ vectorA: VectorA, _ vectorB: VectorB, operation: (UnsafeBufferPointer<Float>, UnsafeBufferPointer<Float>) -> [Float]) -> [Float]
